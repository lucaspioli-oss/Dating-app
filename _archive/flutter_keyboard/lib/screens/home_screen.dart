...
class _HomeScreenState extends State<HomeScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('Flirt Keyboard'),
        ...
        child: Column(
          ...
          children: [
            ...
            _buildInstructionStep(
              '1',
              'Habilitar Teclado',
              'Vá em Ajustes > Geral > Teclado > Teclados > Adicionar Novo Teclado > Flirt Keyboard',
            ),
            _buildInstructionStep(
              '2',
              'Ativar Acesso Total',
              'Toque no Flirt Keyboard e ative "Permitir Acesso Total"',
            ),
            _buildInstructionStep(
              '3',
              'Copiar Mensagem',
            ...
            _buildInstructionStep(
              '4',
              'Usar Teclado',
              'Troque para o Flirt Keyboard e toque em "Sugerir Resposta"',
            ),
          ],
        ),
      ),
