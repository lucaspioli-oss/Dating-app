...
export const BASIC_PROMPTS: Record<string, string> = {
...
export const ADVANCED_PROMPTS: Record<string, string> = {
...
export function getSystemPromptForTone(tone: string): string {
  ...
  if (tone === 'ousado' || tone === 'confiante') {
    return ADVANCED_PROMPTS[tone] || ADVANCED_PROMPTS.confiante;
  }

  // 🟢 NÍVEL 1: Básico
  return BASIC_PROMPTS[tone] || BASIC_PROMPTS.casual;
}
