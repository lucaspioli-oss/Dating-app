...
5. Clique no `+` e adicione: `group.com.desenrolaai.app.shared`
...
3. Clique em `+ Capability`
4. Adicione `App Groups`
5. Clique no `+` e adicione o MESMO grupo: `group.com.desenrolaai.app.shared`
...
3. Configure:
   - **Bundle Identifier**: `com.desenrolaai.app`
...
2. Vá em `General` > `Identity`
3. Configure:
   - **Bundle Identifier**: `com.desenrolaai.app.FlirtKeyboardExtension`
...
**Erro comum**: "group.com.desenrolaai.app.shared" não existe
