...
@objc class AppDelegate: FlutterAppDelegate {
    ...
    private func isKeyboardEnabled() -> Bool {
        ...
        // Formato: com.yourcompany.flirtkeyboard.KeyboardExtension
        return keyboards.contains { $0.contains("FlirtKeyboardExtension") }
    }
    ...
    private func saveToSharedDefaults(key: String, value: String) {
        ...
        if let sharedDefaults = UserDefaults(suiteName: "group.com.flirtkeyboard.shared") {
